 ...
 * Untuk XLSX
 */
public class BaseXSSFWorkbook extends XSSFWorkbook {

	/** The Constant LOG. */
	private static final Log LOG = LogFactory.getLog(BaseXSSFWorkbook.class);
	 ...
	 */
	public BaseXSSFWorkbook(Map<String, Object> reportMap) {
	 ...
	 * @param reportName
	 */
	public BaseXSSFWorkbook(Map<String, Object> excelMap, String reportName) {
		super();
	 ...
	 * @param inputStream
	 */
	public BaseXSSFWorkbook(Map<String, Object> excelMap,
			InputStream inputStream) throws IOException {
//		super(new POIFSFileSystem(inputStream));
//		super(new POIFSFileSystem(inputStream));
		super(inputStream);
//		new XSSFWorkbook(is)
