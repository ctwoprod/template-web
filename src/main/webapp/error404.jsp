...
<link rel="icon" type="image/png"
	href="<c:url value='/assets/images/logo-ipems.png'/>" sizes="32x32">
<title>template-web Error 404</title>
<meta name="viewport"
...
<body>
	<h1 class="error_heading">404</h1>
	<h2 class="error_subheading">
		The requested URL <strong>${requestScope['javax.servlet.forward.request_uri']}</strong>
